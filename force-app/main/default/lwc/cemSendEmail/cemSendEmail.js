...
export default class CemSendEmail extends LightningElement {
    ...
    */
    ...
    handleShowPreview(event) {
        ...
        //let bdy = this.emailBody;
        //console.log('Body :: ',this.emailBody);
        this.previewEmailBody = this.emailBody;
    ...
    onSelectEmailTemplate() {
        ...
        try{
            ...
            .then(result => {
                ...
                this.previewEmailBody = result[1];
                this.previewEmailSubject = result[0];
                this.showPreviewEmail = true;
            })
            .catch(error => {
                console.error('Lookup error', JSON.stringify(error));
   ...
   /* const uploadedFiles = event.detail.files[0];
    ...
    handleCloseModel() {
        ...
        if(this.insertMergeField !=undefined && this.insertMergeField !='undefined'){
